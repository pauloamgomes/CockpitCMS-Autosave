<style>
    .autosave-container {
        position:fixed; top:0; bottom:0; left:0; right:0; width:100vw; height:100vh; z-index:99999; background-color: rgba(255,255,255,0.9);
    }
</style>
  ...
  <div class="uk-width-medium-1-2 uk-viewport-height-1-2 uk-container-center uk-flex uk-flex-center uk-flex-middle">
    <div class="uk-animation-fade uk-width-1-1">
      ...
      <div class="uk-panel-box uk-panel-card uk-margin-top">
        <strong class="uk-text-uppercase uk-text-small">@lang('Autosaved by') { autosaved.user.name } @lang(' on ') { autosaved.date }</strong>
        ...
        <div class="uk-margin-top uk-text-center">
          <hr>
          <div>
            <button class="uk-button uk-button-large uk-button-primary" onclick="{ () => restore(resourceType) }">
...
<script>
  this.resourceType = {{ json_encode($type) }};
